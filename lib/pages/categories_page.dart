...
import 'package:nilediting_app/pages/single_category_page.dart';
...
class _CategoriesPageState extends State<CategoriesPage> {
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image:
                          NetworkImage(ToolsUtilities.ourCategoriesHeaderImage),
                      fit: BoxFit.cover),
                ),
                child: const Padding(
  ...
  Widget _categoryCard(String categoryName, IconData icon, String indexCategory,
      String categoryUrl, int index) {
    return Padding(
